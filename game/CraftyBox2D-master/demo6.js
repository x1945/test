...
var gameInit = function() {
	...
	Crafty.scene("loading", function() {
		...
		.progressBar(100, false, "blue", "green").bind("LOADING_PROGRESS", function(percent) {
			// updateBarProgress(Number currentValue)
			this.updateBarProgress(percent);
		});

		Crafty.load({
			images : [ "img/1066.png", "img/1067.png", "img/1068.png", "img/1046.png", "img/1047.png", "img/1048.png",
					"icon/1066.png", "icon/1067.png", "icon/1068.png", "icon/1046.png", "icon/1047.png",
					"icon/1048.png", "icon/461.png", "icon/462.png", "icon/463.png", "icon/464.png", "icon/465.png",
					"img/IconSet.png", "icon/spinning-sword.png", "icon/comet-spark.png", "icon/checked-shield.png",
					"icon/james-bond-aperture.png", "icon/electric.png", "img/Hexagram.png", "img/Flame.png",
					"img/DarkSpace1.png", "Animations/Attack1.png", "Animations/Attack2.png", "Animations/Attack3.png",
					"Animations/Attack4.png", "Animations/Attack5.png", "Animations/Darkness1.png",
					"Animations/Light7.png", "Animations/Meteor.png", "Animations/Ice3.png", "Animations/Balloon.png",
					"Animations/Heal1.png", "Animations/Heal2.png", "Animations/Heal4.png", "Animations/Heal6.png",
...
var generateWorld = function() {
	...
	Crafty.addEvent(ctx, "mouseup", function() {
		if (gv.canAction) {
			...
			if (selectedBody != null) {
				...
				// 可操作&有移動
				console.log('gv:', gv.canAction, gv.isMouseMove);
				if (gv.canAction && gv.isMouseMove) {
					game.removeTiming();
					game.parseHeroAction();
	...
	Crafty.e("Delay").delay(process, 100, -1);
	// Crafty.e("Delay").delay(process, 200, -1);
}

var process = function() {
	if (gv.heroAction && !gv.attackAnimationPlaying && !gv.heroAnimationPlaying) {
		if (gv.waitArray.length > 0) {
			var hero = gv.waitArray.shift();
		...
		if (gv.waitArray.length == 0 && !gv.attackAnimationPlaying) {
			game.parseEnemyAction();
		}
	}

	// 敵人行動
	if (gv.enemyAction && !gv.attackAnimationPlaying) {
		game.enemyAttack();
	}

	// 勝利victory
	if (!gv.enemyAction && !gv.heroAction && !gv.canAction) {
		var count = 0;
		var end = true;
		while (end && count < gv.enemy.length) {
			end = !gv.enemy[count].has('enemy');
			count++
		}
		if (end)
			Crafty.scene("end");
...
var vec4 = [ new b2Vec2(30, 0), new b2Vec2(-30, 0), new b2Vec2(0, 30), new b2Vec2(0, -30) ];
var vec41 = [ new b2Vec2(20, -20), new b2Vec2(-20, -20), new b2Vec2(20, 20), new b2Vec2(-20, 20) ];
var vec8 = [ new b2Vec2(20, 0), new b2Vec2(-20, 0), new b2Vec2(0, 20), new b2Vec2(0, -20), new b2Vec2(20, -20),
		new b2Vec2(-20, -20), new b2Vec2(20, 20), new b2Vec2(-20, 20) ];
